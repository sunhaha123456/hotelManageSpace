...
public class JumpControler {
     ...
     * @return
     */
    @GetMapping(value = "/user/menuManage/toHotelRoomTypeEnter")
    public String toHotelRoomTypeEnter() {
        return "menu/hotelRoomTypeEnter";
    }
    ...
    /**
     * 功能：跳转到 员工管理下 发薪流水 页面
     * @return
     */
    @GetMapping(value = "/user/menuManage/toEmployerSalaryHistory")
    public String toEmployerSalaryHistory() {
        return "menu/employerSalaryHistory";
    }
}